...
const EcommerceOrderDetail = (props) => {
  const voucherNumID = new URLSearchParams(window.location.search).get('VoucherNumID');
  ...
  return (
    ...
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title={data.voucherName} pageTitle={data.voucherNumber} />

        <Row>
          <Col xl={9}>
            <CPVoucherNumDisplayCard voucher={data} />
            <CPStepsTracking tracking={data.trackingDetails} labelTitle ={"Voucher Tracking"} />
          </Col>

          <Col xl={3}>
            
            <CPVoucherNumLogisticsCard logistics={data.logistics} labelTitle ={"Logistic Details"} />
            <CPVoucherNumHeaderCard data={data} labelTitle ={"Voucher Details"} />
            <CPVoucherNumBillingShippingCard billingShipping={data.billing} labelTitle ={"Billing Details"}  />
            <CPVoucherNumBillingShippingCard billingShipping={data.shipping} labelTitle ={"Shipping Details"}  />
